...
if [ "$STATUS" = "" ]
then
    gcloud compute addresses create "ipython2" --region europe-west1

    echo "creating the VM"
    gcloud compute instances create "$NAME" \
    --zone "us-west1-b" --machine-type "n1-standard-8" --subnet "default" \
...
gcloud compute ssh $NAME --zone=us-west1-b
